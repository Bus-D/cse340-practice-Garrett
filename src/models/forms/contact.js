...
/** 
*Inserts a new contact form submission into database.
*
* @param {string} subject - The subject of the contact message
* @param {string} message - The message content
* @returns {Promise<Object>} The newly created contact ofrm record
*/
...
/**
 * Retrieves all contact form submission, orders by most recent first
 * 
